...
export function SessionChromeBar() {
  ...
  return (
    <View className="border-b border-wood-600/20 bg-ivory">
          ...
          {onTuneScreen ? (
            <View className="items-end gap-1">
              ...
              {hasPlan && hasNext ? (
                ...
                >
                  <Text className="font-sans-medium text-xs text-wood-600">Next section</Text>
                  <ArrowRight color={colors.wood[600]} size={14} style={{ marginTop: 2 }} />
                </AnimatedPressable>
              ) : null}
            </View>
          ) : hasPlan ? (
      ...
      {hasPlan && slots != null ? (
        <Text className="border-t border-wood-600/10 px-4 py-2 font-sans text-xs text-wood-600" numberOfLines={1}>
